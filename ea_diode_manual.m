function [roll_y,y,solution] = ea_diode_manual(side,ct,head_mm,unitvector_mm,tmat_vx2mm,elspec)
%% constant variables
...
Solution1Button = uicontrol('Style', 'pushbutton', 'String', ['Solution 1: ' num2str(round(solution.rolls_deg(1),1)) ' deg'],...
    'Tooltip', ['Solution 1: ' num2str(round(solution.rolls_deg(1),1)) ' deg'],...
    'Position', [75 20 150 25],'FontSize',12,...
    'Callback', @buttonPress);
Solution2Button = uicontrol('Style', 'pushbutton', 'String', ['Solution 2: ' num2str(round(solution.rolls_deg(2),1)) ' deg'],...
    'Tooltip', ['Solution 2: ' num2str(round(solution.rolls_deg(2),1)) ' deg'],...
